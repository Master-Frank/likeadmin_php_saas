...
func TestFrontendRoutesCovered(t *testing.T) {
	...
	tenant := []string{
		...
		"user.user/lists", "user.user/adjustmoney",
		"article.article/lists", "article.article/updatestatus",
		"article.articlecate/lists", "article.articlecate/detail", "article.articlecate/updatestatus",
		"decorate.data/article", "decorate.data/pc",
		"setting.web.web_setting/getcopyright", "setting.web.web_setting/getsitestatistics",
		"setting.user.user/getconfig", "setting.storage/lists", "setting.pay.pay_way/getpayway",
