...
func TestFrontendRoutesCovered(t *testing.T) {
	platform := []string{
		...
		"auth.menu/route", "auth.menu/updatestatus",
		...
		"channel.official_account_setting/getconfig", "channel.official_account_setting/setconfig",
		"channel.official_account_menu/detail", "channel.official_account_menu/save",
		"channel.official_account_menu/saveandpublish",
		"channel.official_account_reply/lists", "channel.official_account_reply/sort",
		"channel.official_account_reply/add", "channel.official_account_reply/edit",
		"channel.official_account_reply/delete", "channel.official_account_reply/detail",
		"channel.official_account_reply/status",
		"channel.mnp_settings/getconfig", "channel.mnp_settings/setconfig",
		"channel.open_setting/getconfig", "channel.open_setting/setconfig",
		"channel.web_page_setting/getconfig", "channel.web_page_setting/setconfig",
		"channel.app_setting/getconfig", "channel.app_setting/setconfig",
		"setting.transaction_settings/getconfig", "setting.transaction_settings/setconfig",
		"setting.customer_service/getconfig", "setting.customer_service/setconfig",
	...
	tenant := []string{
		...
		"auth.menu/route", "auth.menu/updatestatus",
		"setting.web.web_setting/getwebsite", "setting.web.web_setting/setwebsite",
		"setting.web.web_setting/getagreement",
		"setting.pay.pay_way/setpayway", "setting.pay.pay_config/getconfig", "setting.pay.pay_config/setconfig",
		"setting.dict.dict_type/lists", "setting.dict.dict_type/all", "setting.dict.dict_type/detail",
		"setting.dict.dict_data/lists", "setting.dict.dict_data/detail",
		"setting.storage/lists", "crontab.crontab/detail", "crontab.crontab/expression",
		"tools.generator/datatable", "tools.generator/generatetable", "tools.generator/detail",
		"tools.generator/synccolumn", "tools.generator/delete", "tools.generator/edit", "tools.generator/getmodels",
		"decorate.page/detail", "decorate.page/save", "decorate.tabbar/detail", "decorate.tabbar/save",
		"channel.official_account_setting/getconfig", "channel.official_account_setting/setconfig",
		"channel.mnp_settings/getconfig", "channel.mnp_settings/setconfig",
		"channel.open_setting/getconfig", "channel.open_setting/setconfig",
		"channel.web_page_setting/getconfig", "channel.web_page_setting/setconfig",
		"channel.official_account_menu/detail",
		"channel.official_account_reply/lists", "channel.official_account_reply/edit",
		"channel.official_account_reply/delete", "channel.official_account_reply/detail",
		"finance.account_log/lists", "finance.refund/record", "finance.refund/stat",
		"recharge.recharge/lists", "recharge.recharge/getconfig", "recharge.recharge/setconfig",
		"recharge.recharge/refundagain", "notice.notice/detail", "notice.notice/set",
		"notice.sms_config/detail", "setting.hot_search/getconfig",
		"setting.transaction_settings/getconfig", "setting.transaction_settings/setconfig",
		"setting.customer_service/getconfig", "setting.customer_service/setconfig",
	}
	api := []string{
